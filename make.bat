...
SETLOCAL
SET PROJECT_DIR=%cd%
SET PROJECT_NAME=medical-fraud-detection-examples
SET SUPPORT_LIBRARY = med_fraud
SET ENV_NAME=med-fraud
...
:build_upload
    ENDLOCAL & (
        ...
        :: Build conda package
        CALL conda build ./conda-recipe --output-folder ./conda-recipe/conda-build
        CALL anaconda upload ./conda-recipe/conda-build/win-64/medical-fraud-detection-examples*.tar.bz2
